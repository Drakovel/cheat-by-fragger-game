...
namespace Client
{
	...
	void OnRenderGUI()
	{
		...
		/*	if (tabSelected == 0) // Welcome
			{
				ImGui::Text("Welcome to ZEROHACK's Indigo");
				if (ImGui::Button("ZEROHACK Official Website"))
				{
					ShellExecute(NULL, "open", "http://ZEROHACK/indigo", NULL, NULL, SW_SHOW);
				}*/
...
ImGui::Text("This Project is a free open source project made possible by Troll Face#1136");
				...
				else if (tabSelected == 5) // Misc
				{
					...
					string clan_1 = "None";
					string clan_2 = "Clear";
					string clan_3 = "ZEROHACK";
					string clan_4 = "ZEROHACK No-name";
					string clan_5 = "Valve";
