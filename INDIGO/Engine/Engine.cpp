...
//[junk_enable /]
	...
	void ClanTag()
	{
		...
		case 2:
		{
			SetMyClanTag("ZEROHACK", "ZEROHACK");
			break;
		}
		case 3:
		{
			SetMyClanTag("ZEROHACK \r", "ZEROHACK only");
			break;
		}
		case 4:
		{
		...
		case 6:
		{
			...
			case 0:
			{
				SetMyClanTag("", "ZEROHACK");
				break;
			}
			case 1:
			{
				SetMyClanTag("S", "ZEROHACK");
				break;
			}
			case 2:
			{
				SetMyClanTag("SM", "ZEROHACK");
				break;
			}
			case 3:
			{
				SetMyClanTag("SME", "ZEROHACK");
				break;
			}
			case 4:
			{
				SetMyClanTag("SMEF", "ZEROHACK");
				break;
			}
			case 5:
			{
	...
	{
		std::vector<std::string> chatspam = { "ZEROHACK | Creator of ZEROHACK's Indigo" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "ZEROHACK | Creator of ZEROHACK's Indigo" , "I'm legit stfu coon" , "I USE ZEROHACK'S INDIGO","ZEROHACK'S INDIGO" };
